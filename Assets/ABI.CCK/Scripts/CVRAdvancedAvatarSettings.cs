...
namespace ABI.CCK.Scripts
{
    ...
    public class CVRAdvancesAvatarSettingBase
    {
        ...
        public virtual void SetupAnimator(ref AnimatorController controller, string machineName, string folderPath, string fileName)
        {
    ...
    public class CVRAdvancesAvatarSettingGameObjectToggle : CVRAdvancesAvatarSettingBase 
    {
        ...
        public override void SetupAnimator(ref AnimatorController controller, string machineName, string folderPath, string fileName)
        {
