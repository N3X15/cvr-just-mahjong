...
namespace ABI.CCK.Scripts
{
    ...
    {
        private const string BaseVersion = "3.8";
        private const int BuildNumber = 104;
        private const string ReleaseType = "Preview"; // Preview, Release ?
        
        public static string CCK_VERSION 
            => $"{BaseVersion} {BuildNumber}";
        public static string CCK_VERSION_NUMBER
            => BaseVersion;
        public static int CCK_BUILD_NUMBER 
            => BuildNumber;
        public static string CCK_VERSION_FULL
            => $"{BaseVersion} {ReleaseType} (Build {BuildNumber})";
